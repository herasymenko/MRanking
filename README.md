...
5. Save a private pack and start **King of the Hill**, **Wheel** or **Ranked**.

At least 16 playable items are required. Duplicate, private, deleted and unavailable entries are skipped during import. Imported packs, in-progress games and final results persist in local SQLite storage. Ranked orders groups of up to four items, qualifies a top 100 from larger packs, and lets the user manually adjust the saved final list.
